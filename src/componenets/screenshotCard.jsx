...
export default function HowtoCards() {
  return (
    <>
      <h1 className="text-center text-success mt-5 display-1">
        HOW TO
      </h1>
      <CardGroup className="mt-4 px-5 d-flex flex-column flex-lg-row">
        ...
        <Card className="mx-3  border-0">
          ...
          <img className="card-img-top rounded h-sm-50" src={screenShot} alt="Card image1" />

          <cardbody className="mt-1">
            <h5 className="card-title text-center text-success display-3 ">Card title</h5>
            <p className="card-text text-center display-xs-3">This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.</p>
